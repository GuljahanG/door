...
use App\Http\Controllers\Web\OrderController as ClientOrderController;
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
...
Route::post('change_color', [CalculatePriceController::class, 'change_color'])->name('change_color');
